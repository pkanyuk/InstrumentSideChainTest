//
//  InstrumentSideChainTestExtensionDSPKernel.hpp
...
#import "InstrumentSideChainTestExtension-Swift.h"
#import "InstrumentSideChainTestExtensionParameterAddresses.h"

/*
 InstrumentSideChainTestExtensionDSPKernel
 As a non-ObjC class, this is safe to use from render thread.
 */
class InstrumentSideChainTestExtensionDSPKernel {
public:
    ...
    // Add a case for each parameter in InstrumentSideChainTestExtensionParameterAddresses.h
    void setParameter(AUParameterAddress address, AUValue value) {
        switch (address) {
            case InstrumentSideChainTestExtensionParameterAddress::gain:
                mGain = value;
                break;
        }
    }
    ...
    void handleMIDIEventList(AUEventSampleTime now, AUMIDIEventList const* midiEvent) {
        auto visitor = [] (void* context, MIDITimeStamp timeStamp, MIDIUniversalMessage message) {
            auto thisObject = static_cast<InstrumentSideChainTestExtensionDSPKernel *>(context);
