//
//  InstrumentSideChainTestExtensionAudioUnit.mm
//  InstrumentSideChainTestExtension
//
//  Created by Paul Kanyuk on 5/19/23.
//

#import "InstrumentSideChainTestExtensionAudioUnit.h"

#import <AVFoundation/AVFoundation.h>
#import <CoreAudioKit/AUViewController.h>

#import "InstrumentSideChainTestExtensionAUProcessHelper.hpp"
#import "InstrumentSideChainTestExtensionDSPKernel.hpp"


// Define parameter addresses.

@interface InstrumentSideChainTestExtensionAudioUnit ()
...
@implementation InstrumentSideChainTestExtensionAudioUnit {
    // C++ members need to be ivars; they would be copied on access if they were properties.
    InstrumentSideChainTestExtensionDSPKernel _kernel;
...
- (void)setupParameterCallbacks {
    ...
    __block InstrumentSideChainTestExtensionDSPKernel *kernel = &_kernel;
