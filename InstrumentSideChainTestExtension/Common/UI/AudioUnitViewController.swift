...
private let log = Logger(subsystem: "pkanyuk.InstrumentSideChainTestExtension", category: "AudioUnitViewController")

public class AudioUnitViewController: AUViewController, AUAudioUnitFactory {
    var audioUnit: AUAudioUnit?
    
    var hostingController: HostingController<InstrumentSideChainTestExtensionMainView>?
	...
	*/
    ...
    public func createAudioUnit(with componentDescription: AudioComponentDescription) throws -> AUAudioUnit {
        audioUnit = try InstrumentSideChainTestExtensionAudioUnit(componentDescription: componentDescription, options: [])
        
        guard let audioUnit = self.audioUnit as? InstrumentSideChainTestExtensionAudioUnit else {
            log.error("Unable to create InstrumentSideChainTestExtensionAudioUnit")
            return audioUnit!
        }
        ...
        audioUnit.setupParameterTree(InstrumentSideChainTestExtensionParameterSpecs.createAUParameterTree())
    ...
    private func configureSwiftUIView(audioUnit: AUAudioUnit) {
        ...
        let content = InstrumentSideChainTestExtensionMainView(parameterTree: observableParameterTree)
