//
//  InstrumentSideChainTestExtensionAUProcessHelper.hpp
...
#include <vector>
#include "InstrumentSideChainTestExtensionDSPKernel.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(InstrumentSideChainTestExtensionDSPKernel& kernel, UInt32 outputChannelCount)
    : mKernel{kernel},
...
private:
    InstrumentSideChainTestExtensionDSPKernel& mKernel;
